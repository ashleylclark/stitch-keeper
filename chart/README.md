...
[![AppVersion: v0.5.3](https://img.shields.io/badge/AppVersion-v0.5.3-informational?style=flat-square)](Chart.yaml)
...
```bash
helm install stitch-keeper oci://ghcr.io/ashleylclark/charts/stitch-keeper --version 0.1.4
```
...
```bash
helm upgrade stitch-keeper oci://ghcr.io/ashleylclark/charts/stitch-keeper --version 0.1.4
```
