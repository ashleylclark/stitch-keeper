...
[![AppVersion: v0.3.1](https://img.shields.io/badge/AppVersion-v0.3.1-informational?style=flat-square)](Chart.yaml)
...
```bash
helm install stitch-keeper oci://ghcr.io/ashleylclark/charts/stitch-keeper --version 0.1.1
```
...
```bash
helm upgrade stitch-keeper oci://ghcr.io/ashleylclark/charts/stitch-keeper --version 0.1.1
```
