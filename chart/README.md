...
[![AppVersion: v0.6.0](https://img.shields.io/badge/AppVersion-v0.6.0-informational?style=flat-square)](Chart.yaml)
...
```bash
helm install stitch-keeper oci://ghcr.io/ashleylclark/charts/stitch-keeper --version 0.1.5
```
...
```bash
helm upgrade stitch-keeper oci://ghcr.io/ashleylclark/charts/stitch-keeper --version 0.1.5
```
